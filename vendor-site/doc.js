...
(function () {
  ...
  // роботом, который скрипты не исполняет. Заполненные поля документа
  // не заменяются текущими реквизитами: обновление legal.js не должно
  // молча менять дату или сторону уже опубликованной редакции.
  ...
  for (var i = 0; i < slots.length; i++) {
    ...
    if (value && !written) slots[i].textContent = value;
  }
