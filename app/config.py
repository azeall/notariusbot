...
class Settings(BaseSettings):
    ...
    # Куда писать о поломках сервиса. Пусто — присмотр работает, но молчит:
    # это осознанный выбор, а не забытая настройка. Свой chat_id узнать
    # можно, написав боту и открыв /admin/staff — там же, где сотрудники
    # привязывают Telegram.
